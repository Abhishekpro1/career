...
#cooltext{
    ...
    <!-- //header -->
    <div class="main-content" id="home" style="margin-bottom: 0%;">
        <div class="overlay">
            <!-- //header -->
            <div class="container">
                <!-- /banner -->
                <div class="banner-info text-left">
                    <h3>The Start of New Begining</h3>
                    <p class="my-3">Career guidance is the guidance given to individuals to help them acquire the knowledge, information, skills, and experience necessary to identify career options, and narrow them down to make one career decision.</p>
                    <div class="read-more-button">
                        <a href="carer_library.php" class="read-more scroll btn">Explore Our Conselling Program</a><br>
                        <br>
                        <a href="e-books.php" class="read-more scroll btn">Explore Our E-Books</a>  
                    </div>
                </div>
            </div>
            <!-- //banner -->
        ...
        <div class="container py-md-5" >
            <div class="row banner-grids mb-lg-5">
                ...
                <div class="col-lg-5 content-left" id="slider">
                    <figure>
                        <img src="images/slider/desk4.jpg">
                        <img src="images/slider/desk5.jpg">
                        <img src="images/slider/desk6.jpg">
                        <img src="images/slider/desk7.jpg">
                        <img src="images/slider/desk4.jpg">
		            </figure>
                </div>
            </div>
            ...
            <div class="row ab-info second mt-lg-4 text-center">
                ...
                <div class="col-lg-4 ab-content">
                    <a href="Indian_Armed_Forces.php" class="read-more two btn m-0 px-3"><span class="fa fa-long-arrow-right"> </span></a>
                </div>
            </div>
                ...
                <div class="row banner-grids mb-lg-5">
                     <div class="col-lg-5 content-left" id="slider">
                         ...
                         <br>
                    <figure>
                        <img src="images/slider/desk.jpg">
                        <img src="images/slider/desk2.png">
                        <img src="images/slider/desk3.jpeg">
                        <img src="images/slider/desk9.jpg">
                        <img src="images/slider/desk.jpg">
		            </figure>
                       </div>
                <div class="col-lg-7 content-right">
